...
// this is a system-level open file table that
// holds open files of all process.
...
static struct inode *create(char *path, short type)
{
	...
	printk("create dinode and inode type = %d\n", type);
